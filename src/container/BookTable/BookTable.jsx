    ...
    return (
        ...
        <div className="book-table-container">
            <Helmet>
                ...
                <meta property="og:url" content="https://limarestaurant.com.au/#about" />
            </Helmet>

            <h2 className="headtext__matter">Reservations</h2>
            ...
            <ul className="p__heebo">
                ...
                <li>All parties of 8 or more guests will be served our <a href={PdfFood} target="_blank"
                ...
                <li>Any reservation inquiries please email <a className='p__heebo' style={{ textDecoration: 'underline', textTransform: 'none' }} href="mailto:hola@limarestaurant.com.au">hola@limarestaurant.com.au</a></li>
            </ul>
