...
const BookTable = () => {
    ...
    return (
        <div className="book-table-container">
            ...
            <h2 className="headtext__cormorant">Reservations</h2>
            <p className="p__opensans">Thank you for your interest in booking with us.
            ...
            <ul className="p__opensans">
                ...
                <li>All parties of 6 or more guests will be served our <a href={PdfFood} target="_blank"
                    rel="noreferrer" style={{textDecoration:'underline'}}>“Let the Peruvians Feed You” Tasting Menu</a>. If you’re booking for 6 or more, please ensure you are happy with the menu before completing your reservation. </li>
                ...
                <li>Unfortunately, we cannot fit prams in the venue on Friday and Saturday nights. All other sittings are available on request.</li>
                <li>Any reservation inquiries please email <a className='p__opensans' style={{ textDecoration: 'underline', textTransform: 'none' }} href="mailto:hola@folklorrestaurant.com.au">hola@folklorrestaurant.com.au</a></li>
            </ul>
