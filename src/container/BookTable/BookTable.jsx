        ...
        <div className="book-table-container">
            ...
            <ul className="p__opensans">
                ...
                <li>All parties of 6 or more guests will be served our <a href={PdfFood} target="_blank"
                    rel="noreferrer" style={{textDecoration:'underline'}}>“Let the Peruvians Feed You” Tasting Menu</a>. If you’re booking for 8 or more, please ensure you are happy with the menu before completing your reservation. </li>
